...
//displaying the appropriate imnage according to lives remaining
if(life===3){
  heart3.visible = true
  heart2.visible = false
  heart1.visible = false
...
if(gameState =="Lost"){
  ...
  zombieGroup.destroy.Each();
  player.destroy();
}

//destroy zombie and player and display a message in a gameState "Won"
...
function enemy(){
  if(frameCount%50===0){
    ...
    //givintg random x and y positions for zombies to appear
